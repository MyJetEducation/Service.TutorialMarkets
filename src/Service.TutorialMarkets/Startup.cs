...
using Service.TutorialMarkets.Modules;
using Service.TutorialMarkets.Services;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.TutorialMarkets
{
	public class Startup
	{
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			{
				endpoints.MapGrpcSchema<TutorialMarketsService, ITutorialMarketsService>();
